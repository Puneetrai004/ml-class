...
# logging code
run = wandb.init(project="fashion_mnist_cnn")
# load data
...
# Fit the model
model.fit(X_train, y_train, epochs = 10, validation_data = (X_test, y_test), callbacks = [WandbCallback(data_type = "image", labels = labels)])
